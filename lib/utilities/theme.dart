...
class LightModeTheme extends FlutterTheme {
  ...
  late Color tertiary = const Color(0xFF344054);
  late Color alternate = const Color(0xFFFEB273);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFFFD853A);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF1D2939);
  late Color accent2 = const Color(0xFFF9FAFB);
  late Color accent3 = const Color(0xFF292D32);
  late Color accent4 = const Color(0xFFD0D5DD);
