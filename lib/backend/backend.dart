...
import 'schema/testimonials_record.dart';
...
export 'schema/testimonials_record.dart';
...
/// Functions to query TestimonialsRecords (as a Stream and as a Future).
Future<int> queryTestimonialsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TestimonialsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TestimonialsRecord>> queryTestimonialsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TestimonialsRecord.collection,
      TestimonialsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<TestimonialsRecord>> queryTestimonialsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
